...
test("latest big play wraps below sidebar teams and outlives the blue banner", async ({ page }) => {
  ...
  await expect(summary).toContainText("Q1 12:00");
  await expect(summary).toContainText("30 yards");
